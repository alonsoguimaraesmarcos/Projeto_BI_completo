Trata-se de projeto de Business Intelligence completo. Desde a elaboração de um modelo multidimensional, a criação do Data Warehouse no PostgresSQL, extração dos dados, transformação e carga no DW. 
